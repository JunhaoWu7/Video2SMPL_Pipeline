...
def detect_segment_track_sam(images, out_path, paths_dict, debug_masks, sam2_type, 
    ...
    sam2_registry = {
        'tiny': {
            ...
            'config': "phmr_pipeline/sam2/sam2_hiera_t.yaml",
        },
        'small': {
            'checkpoint': paths_dict['sam2'] + '/sam2_hiera_small.pt',
            'config': "phmr_pipeline/sam2/sam2_hiera_s.yaml",
        },
        'base_plus': {
            'checkpoint': paths_dict['sam2'] + '/sam2_hiera_base_plus.pt',
            'config': "phmr_pipeline/sam2/sam2_hiera_b+.yaml",
        },
        'large': {
            'checkpoint': paths_dict['sam2'] + '/sam2_hiera_large.pt',
            'config': "phmr_pipeline/sam2/sam2_hiera_l.yaml"
        },
    }
    ...
    if detector_type == 'detectron2':
        # ViTDet
        cfg_path = 'phmr_pipeline/detectron2/keypoint_rcnn_X_101_32x8d_FPN_3x.yaml'
