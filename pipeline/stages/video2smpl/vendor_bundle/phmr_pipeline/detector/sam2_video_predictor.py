...
def build_sam2_video_predictor(
    ...
    **kwargs,
    ...
    hydra_overrides = [
        "++model._target_=phmr_pipeline.detector.sam2_video_predictor.SAM2VideoPredictor",
    ]
    if vos_optimized:
        hydra_overrides = [
            "++model._target_=phmr_pipeline.detector.sam2_video_predictor.SAM2VideoPredictorVOS",
