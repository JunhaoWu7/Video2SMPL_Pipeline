...
from phmr_pipeline.detector import segment
from phmr_pipeline.detector.vitpose_estimator import load_vit_model, estimate_kp2ds_from_bbox_vitpose
from phmr_pipeline.kp_utils import convert_kps
from phmr_pipeline.utils import prepare_inputs, load_video_frames, interpolate_bboxes
from phmr_pipeline.tools import detect_track, detect_segment_track_sam, est_camera, est_calib
from phmr_pipeline.phmr_vid import PromptHMR_Video
from phmr_pipeline.camera import run_metric_slam, calibrate_intrinsics, run_slam
from phmr_pipeline.spec import run_cam_calib
from phmr_pipeline.world import world_hps_estimation
...
class Pipeline:
    def __init__(self, static_cam=False):
        self.images = None
        self.cfg = OmegaConf.load("phmr_pipeline/config.yaml")
